...
<required_reading>
Read `/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
