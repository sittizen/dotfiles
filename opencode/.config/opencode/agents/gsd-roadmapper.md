...
Reference full template: `/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/templates/state.md`.
