...
<reference>
@/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/user-profiling.md` to load:
