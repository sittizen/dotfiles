...
<required_reading>
Read `/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
