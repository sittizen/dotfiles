...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/simone.cittadini@gruppomol.lcl/.config/opencode/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/simone.cittadini@gruppomol.lcl/.config/opencode/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/simone.cittadini@gruppomol.lcl/.config/opencode/commands/gsd
AGENTS_DIR=/home/simone.cittadini@gruppomol.lcl/.config/opencode/agents
```
...
<execution_context>
Surface state file: `/home/simone.cittadini@gruppomol.lcl/.config/opencode/skills/.gsd-surface.json`
Install profile marker: `/home/simone.cittadini@gruppomol.lcl/.config/opencode/skills/.gsd-profile`
