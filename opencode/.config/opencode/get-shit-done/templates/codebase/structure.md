...
- Usage: Reference from command with `@/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/simone.cittadini@gruppomol.lcl/.config/opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/simone.cittadini@gruppomol.lcl/.config/opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
