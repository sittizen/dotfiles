...
- **Global scope**: `/home/simone.cittadini@gruppomol.lcl/.config/opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/simone.cittadini@gruppomol.lcl/.config/opencode/notes/`)
...
2. Glob `/home/simone.cittadini@gruppomol.lcl/.config/opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/simone.cittadini@gruppomol.lcl/.config/opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/simone.cittadini@gruppomol.lcl/.config/opencode/notes/` — works in any directory
