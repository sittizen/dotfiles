...
INSTALL_JS_GLOBAL="/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
