...
```
Task(
  prompt="Read /home/simone.cittadini@gruppomol.lcl/.config/opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/templates/SECURITY.md`
