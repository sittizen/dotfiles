...
```
Agent(
  prompt="Read /home/simone.cittadini@gruppomol.lcl/.config/opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/templates/VALIDATION.md`
