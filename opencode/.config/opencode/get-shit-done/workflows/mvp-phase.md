...
<required_reading>
@/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/user-story-template.md
@/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/spidr-splitting.md
@/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/references/spidr-splitting.md`. Briefly:
