...
```markdown
Read /home/simone.cittadini@gruppomol.lcl/.config/opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/simone.cittadini@gruppomol.lcl/.config/opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/simone.cittadini@gruppomol.lcl/.config/opencode/agents/gsd-ui-checker.md for instructions.
